...
public class StringUtil {
	 ...
	 * @return
	 */
	public static String getSplitString(String s,String regex){
		String str=NULLSTR;
	 ...
	 * @return
	 */
	public static String listToStringWithNoSingleQuotes(List<String> list){
		StringBuffer s=new StringBuffer();
		if(null!=list && list.size()>0){
			int t=list.size();
			for (int i = 0; i < t; i++) {
...
//  判断�?个字符串是否是整�?
	...
	public static String subStr(String value,int len,boolean isCut){
		if(value!="" && value!=null){
	...
	public static void main(String[] args) {
		...
		System.out.println(stru.simpleToCompl("现代服务业综合试点宣传片"));
