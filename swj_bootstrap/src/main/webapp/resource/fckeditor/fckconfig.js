...
{
	// Basic Inline Styles.
	'Bold'			: { Element : 'span', Overrides : 'b',Styles:{'font-weight':'bold'} },
...
var _FileBrowserLanguage	= 'svl' ;	// asp | aspx | cfm | lasso | perl | php | py
var _QuickUploadLanguage	= 'svl' ;	// asp | aspx | cfm | lasso | perl | php | py
